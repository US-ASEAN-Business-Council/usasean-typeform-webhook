const generateObject = (req, temp ,callback) =>{
	...
	// }
	...
	else if(temp.params.collectionid == process.env.WEBFLOW_12){
		let answers = req.form_response.answers
		let body = {
			client: answers.filter((item)=> item.field.ref === '01F1HK19XVNTGAKF4V80FF07D3')[0] ? answers.filter((item)=> item.field.ref === '01F1HK19XVNTGAKF4V80FF07D3')[0].text : null,
			name: answers.filter((item)=> item.field.ref === '01F1HK19XVNTGAKF4V80FF07D3')[0] ? answers.filter((item)=> item.field.ref === '01F1HK19XVNTGAKF4V80FF07D3')[0].text : null,
		...
		console.log(body)
		Object.assign(obj, body)
		console.log(`[Singapore Microsite 2023] Adding a new record to a collection with an ID of: ${process.env.WEBFLOW_12}`)
		// Object.assign(obj, {'client': req.form_response.answers.filter((item)=> item.field.ref === '01F1HK19XVNTGAKF4V80FF07D3')[0].text})
		// Object.assign(obj, {'name': req.form_response.answers.filter((item)=> item.field.ref === '01F1HK19XVNTGAKF4V80FF07D3')[0].text})
		// Object.assign(obj, {'view-live-website': req.form_response.answers.filter((item)=> item.field.ref === 'ff2cbb49-aca0-4856-a8fb-3b7b66aa17d9')[0].url})
		// Object.assign(obj, {'company-email':req.form_response.answers.filter((item)=> item.field.ref === 'a90973cf-92b6-46fc-8ee8-cd8d4f1a1efa')[0].email})
	...
	else if(temp.params.collectionid == process.env.WEBFLOW_13){
		let answers = req.form_response.answers
		let body = {
			client: answers.filter((item)=> item.field.ref === '01F1HK19XVNTGAKF4V80FF07D3')[0] ? answers.filter((item)=> item.field.ref === '01F1HK19XVNTGAKF4V80FF07D3')[0].text : null,
			name: answers.filter((item)=> item.field.ref === '01F1HK19XVNTGAKF4V80FF07D3')[0] ? answers.filter((item)=> item.field.ref === '01F1HK19XVNTGAKF4V80FF07D3')[0].text : null,
		...
		console.log(body)
		Object.assign(obj, body)
		console.log(`[Philippines Microsite 2023] Adding a new record to a collection with an ID of: ${process.env.WEBFLOW_13}`)
		// Object.assign(obj, {'client': req.form_response.answers.filter((item)=> item.field.ref === '01F1HK19XVNTGAKF4V80FF07D3')[0].text})
		// Object.assign(obj, {'name': req.form_response.answers.filter((item)=> item.field.ref === '01F1HK19XVNTGAKF4V80FF07D3')[0].text})
		// Object.assign(obj, {'view-live-website': req.form_response.answers.filter((item)=> item.field.ref === 'ff2cbb49-aca0-4856-a8fb-3b7b66aa17d9')[0].url})
		// Object.assign(obj, {'company-email':req.form_response.answers.filter((item)=> item.field.ref === 'a90973cf-92b6-46fc-8ee8-cd8d4f1a1efa')[0].email})
	...
	else if(temp.params.collectionid == process.env.WEBFLOW_14){
		let answers = req.form_response.answers
		let body = {
			client: answers.filter((item)=> item.field.ref === '01F1HK19XVNTGAKF4V80FF07D3')[0] ? answers.filter((item)=> item.field.ref === '01F1HK19XVNTGAKF4V80FF07D3')[0].text : null,
			name: answers.filter((item)=> item.field.ref === '01F1HK19XVNTGAKF4V80FF07D3')[0] ? answers.filter((item)=> item.field.ref === '01F1HK19XVNTGAKF4V80FF07D3')[0].text : null,
		...
		console.log(body)
		Object.assign(obj, body)
		console.log(`[55th ASEAN Economic Ministers' Meeting] Adding a new record to a collection with an ID of: ${process.env.WEBFLOW_14}`)
		// Object.assign(obj, {'client': req.form_response.answers.filter((item)=> item.field.ref === '01F1HK19XVNTGAKF4V80FF07D3')[0].text})
		// Object.assign(obj, {'name': req.form_response.answers.filter((item)=> item.field.ref === '01F1HK19XVNTGAKF4V80FF07D3')[0].text})
		// Object.assign(obj, {'view-live-website': req.form_response.answers.filter((item)=> item.field.ref === 'ff2cbb49-aca0-4856-a8fb-3b7b66aa17d9')[0].url})
		// Object.assign(obj, {'company-email':req.form_response.answers.filter((item)=> item.field.ref === 'a90973cf-92b6-46fc-8ee8-cd8d4f1a1efa')[0].email})
	...
	else if(temp.params.collectionid == process.env.WEBFLOW_15){
		let answers = req.form_response.answers
		let body = {
			client: answers.filter((item)=> item.field.ref === '01F1HK19XVNTGAKF4V80FF07D3')[0] ? answers.filter((item)=> item.field.ref === '01F1HK19XVNTGAKF4V80FF07D3')[0].text : null,
			name: answers.filter((item)=> item.field.ref === '01F1HK19XVNTGAKF4V80FF07D3')[0] ? answers.filter((item)=> item.field.ref === '01F1HK19XVNTGAKF4V80FF07D3')[0].text : null,
		...
		console.log(body)
		Object.assign(obj, body)
		console.log(`[Malaysia Microsite 2024] Adding a new record to a collection with an ID of: ${process.env.WEBFLOW_15}`)
		// Object.assign(obj, {'client': req.form_response.answers.filter((item)=> item.field.ref === '01F1HK19XVNTGAKF4V80FF07D3')[0].text})
		// Object.assign(obj, {'name': req.form_response.answers.filter((item)=> item.field.ref === '01F1HK19XVNTGAKF4V80FF07D3')[0].text})
		// Object.assign(obj, {'view-live-website': req.form_response.answers.filter((item)=> item.field.ref === 'ff2cbb49-aca0-4856-a8fb-3b7b66aa17d9')[0].url})
		// Object.assign(obj, {'company-email':req.form_response.answers.filter((item)=> item.field.ref === 'a90973cf-92b6-46fc-8ee8-cd8d4f1a1efa')[0].email})
	...
	else if(temp.params.collectionid == process.env.WEBFLOW_16){
		let answers = req.form_response.answers
		let body = {
			client: answers.filter((item)=> item.field.ref === '01F1HK19XVNTGAKF4V80FF07D3')[0] ? answers.filter((item)=> item.field.ref === '01F1HK19XVNTGAKF4V80FF07D3')[0].text : null,
			name: answers.filter((item)=> item.field.ref === '01F1HK19XVNTGAKF4V80FF07D3')[0] ? answers.filter((item)=> item.field.ref === '01F1HK19XVNTGAKF4V80FF07D3')[0].text : null,
		...
		console.log(body)
		Object.assign(obj, body)
		console.log(`[Philippines Microsite 2024] Adding a new record to a collection with an ID of: ${process.env.WEBFLOW_16}`)
		// Object.assign(obj, {'client': req.form_response.answers.filter((item)=> item.field.ref === '01F1HK19XVNTGAKF4V80FF07D3')[0].text})
		// Object.assign(obj, {'name': req.form_response.answers.filter((item)=> item.field.ref === '01F1HK19XVNTGAKF4V80FF07D3')[0].text})
		// Object.assign(obj, {'view-live-website': req.form_response.answers.filter((item)=> item.field.ref === 'ff2cbb49-aca0-4856-a8fb-3b7b66aa17d9')[0].url})
		// Object.assign(obj, {'company-email':req.form_response.answers.filter((item)=> item.field.ref === 'a90973cf-92b6-46fc-8ee8-cd8d4f1a1efa')[0].email})
	...
	else if(temp.params.collectionid == process.env.WEBFLOW_17){
		let answers = req.form_response.answers
		let body = {
			client: answers.filter((item)=> item.field.ref === '01F1HK19XVNTGAKF4V80FF07D3')[0] ? answers.filter((item)=> item.field.ref === '01F1HK19XVNTGAKF4V80FF07D3')[0].text : null,
			name: answers.filter((item)=> item.field.ref === '01F1HK19XVNTGAKF4V80FF07D3')[0] ? answers.filter((item)=> item.field.ref === '01F1HK19XVNTGAKF4V80FF07D3')[0].text : null,
		...
		console.log(body)
		Object.assign(obj, body)
		console.log(`[Singapore Microsite 2023] Adding a new record to a collection with an ID of: ${process.env.WEBFLOW_17}`)
		// Object.assign(obj, {'client': req.form_response.answers.filter((item)=> item.field.ref === '01F1HK19XVNTGAKF4V80FF07D3')[0].text})
		// Object.assign(obj, {'name': req.form_response.answers.filter((item)=> item.field.ref === '01F1HK19XVNTGAKF4V80FF07D3')[0].text})
		// Object.assign(obj, {'view-live-website': req.form_response.answers.filter((item)=> item.field.ref === 'ff2cbb49-aca0-4856-a8fb-3b7b66aa17d9')[0].url})
		// Object.assign(obj, {'company-email':req.form_response.answers.filter((item)=> item.field.ref === 'a90973cf-92b6-46fc-8ee8-cd8d4f1a1efa')[0].email})
	...
	else if(temp.params.collectionid == process.env.WEBFLOW_18){
		let answers = req.form_response.answers
		let body = {
			client: answers.filter((item)=> item.field.ref === '01F1HK19XVNTGAKF4V80FF07D3')[0] ? answers.filter((item)=> item.field.ref === '01F1HK19XVNTGAKF4V80FF07D3')[0].text : null,
			name: answers.filter((item)=> item.field.ref === '01F1HK19XVNTGAKF4V80FF07D3')[0] ? answers.filter((item)=> item.field.ref === '01F1HK19XVNTGAKF4V80FF07D3')[0].text : null,
		...
		console.log(body)
		Object.assign(obj, body)
		console.log(`[Indonesia Microsite 2024] Adding a new record to a collection with an ID of: ${process.env.WEBFLOW_18}`)
		// Object.assign(obj, {'client': req.form_response.answers.filter((item)=> item.field.ref === '01F1HK19XVNTGAKF4V80FF07D3')[0].text})
		// Object.assign(obj, {'name': req.form_response.answers.filter((item)=> item.field.ref === '01F1HK19XVNTGAKF4V80FF07D3')[0].text})
		// Object.assign(obj, {'view-live-website': req.form_response.answers.filter((item)=> item.field.ref === 'ff2cbb49-aca0-4856-a8fb-3b7b66aa17d9')[0].url})
		// Object.assign(obj, {'company-email':req.form_response.answers.filter((item)=> item.field.ref === 'a90973cf-92b6-46fc-8ee8-cd8d4f1a1efa')[0].email})
	...
	else if(temp.params.collectionid == process.env.WEBFLOW_19){
		let answers = req.form_response.answers
		let body = {
			client: answers.filter((item)=> item.field.ref === '01F1HK19XVNTGAKF4V80FF07D3')[0] ? answers.filter((item)=> item.field.ref === '01F1HK19XVNTGAKF4V80FF07D3')[0].text : null,
			name: answers.filter((item)=> item.field.ref === '01F1HK19XVNTGAKF4V80FF07D3')[0] ? answers.filter((item)=> item.field.ref === '01F1HK19XVNTGAKF4V80FF07D3')[0].text : null,
	...
	else if(temp.params.collectionid == process.env.WEBFLOW_21){
		let answers = req.form_response.answers
		let body = {
			client: answers.filter((item)=> item.field.ref === '01F1HK19XVNTGAKF4V80FF07D3')[0] ? answers.filter((item)=> item.field.ref === '01F1HK19XVNTGAKF4V80FF07D3')[0].text : null,
			name: answers.filter((item)=> item.field.ref === '01F1HK19XVNTGAKF4V80FF07D3')[0] ? answers.filter((item)=> item.field.ref === '01F1HK19XVNTGAKF4V80FF07D3')[0].text : null,
		...
		console.log(body)
		Object.assign(obj, body)
		console.log(`[Indonesia Microsite 2025] Adding a new record to a collection with an ID of: ${process.env.WEBFLOW_21}`)
		// Object.assign(obj, {'client': req.form_response.answers.filter((item)=> item.field.ref === '01F1HK19XVNTGAKF4V80FF07D3')[0].text})
		// Object.assign(obj, {'name': req.form_response.answers.filter((item)=> item.field.ref === '01F1HK19XVNTGAKF4V80FF07D3')[0].text})
		// Object.assign(obj, {'view-live-website': req.form_response.answers.filter((item)=> item.field.ref === 'ff2cbb49-aca0-4856-a8fb-3b7b66aa17d9')[0].url})
		// Object.assign(obj, {'company-email':req.form_response.answers.filter((item)=> item.field.ref === 'a90973cf-92b6-46fc-8ee8-cd8d4f1a1efa')[0].email})
